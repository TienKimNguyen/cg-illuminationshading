...
void main() {
    ...
    for (int i = 0; i < 30; i++) {
        ...
        diffuse = diffuse + curr_light_color * max(dot(world_normal, light_direction), 0.0);
        ...
        specular = specular + curr_light_color * pow(max(dot(reflection_light, view_direction), 0.0), material_shininess);    
    }
